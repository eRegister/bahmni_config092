...
(
    ...
    SELECT
        ...
        SUM(CASE WHEN Gender = 'M'
                  AND Program_Status = 'Initiation'
                 THEN 1 ELSE 0 END) AS Male_Initiated,

        SUM(CASE WHEN Gender = 'M'
                  AND Program_Status = 'Seen'
                 THEN 1 ELSE 0 END) AS Male_Seen,

        SUM(CASE WHEN Gender = 'M'
                  AND Program_Status = 'Seen Previous'
                 THEN 1 ELSE 0 END) AS Male_Seen_Previous,

        SUM(CASE WHEN Gender = 'F'
                  AND Program_Status = 'Initiation'
                 THEN 1 ELSE 0 END) AS Female_Initiated,

        SUM(CASE WHEN Gender = 'F'
                  AND Program_Status = 'Seen'
                 THEN 1 ELSE 0 END) AS Female_Seen,

        SUM(CASE WHEN Gender = 'F'
                  AND Program_Status = 'Seen Previous'
                 THEN 1 ELSE 0 END) AS Female_Seen_Previous,
    ...
    (
        /* =========================================================
           PASTE YOUR COMPLETE UNION QUERY HERE
        ========================================================= */
        (SELECT DISTINCT
...
ORDER BY patientName
    ...
    (
        /* =========================================================
           PASTE THE SAME COMPLETE UNION QUERY HERE
        ========================================================= */
        (SELECT DISTINCT
    pi.identifier AS patientIdentifier,
    CONCAT(pn.given_name,' ',pn.family_name) AS patientName,
